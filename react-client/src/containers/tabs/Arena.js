    ...
    return (
      ...
      <div>
        ...
        <div className="buttonsWrapper">
          {/* <OrderButton /> */}
          <Modal 
            trigger={<Button className="theme-text theme-button" onClick={this.openMonster}>Create a Monster</Button>}
          ...
          <Modal 
            trigger={<Button className="theme-text theme-button" onClick={this.openPlayer}>Create a Player</Button>}
